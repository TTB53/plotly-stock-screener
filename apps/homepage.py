                            ...
                            children=[
                                dbc.Card(
                                    ...
                                    children=[
                                        ...
                                        html.A(className="btn btn-primary", href="/apps/fundamentals",
                                ...
                                dbc.Card(
                                    ...
                                    children=[
                                        ...
                                        html.A(className="btn btn-primary", href="/apps/technical",
                                               children=["Technical Analysis"]),
                                        # dbc.CardLink("Card link", href="/apps/technical"),
                                    ],
...
def update_sector_roi_chart(pattern_value):
    if pattern_value:
        conn = dbObj.create_connection(dbObj.DB_FILE)
        sector_balancesheet_sql = dbObj.create_sql_string('data/SQL/SectorandSubsectorTotalsTable.sql')
        sector_earnings_sql = dbObj.create_sql_string('data/SQL/SectorandSubsectorEarnings.sql')
